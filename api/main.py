...
def _patients_prets_pour_ml():
    """
    Retourne la liste des patient_id ayant au moins 7 jours de prises
    avec statut 'pris' ou 'manque' dans la base.
    Un patient est 'prêt' si ses prises couvrent >= 7 jours calendaires distincts.
    """
    conn = get_connection()
    try:
        cursor = conn.cursor()
