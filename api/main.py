            ...
            try:
                ...
                for (patient_id,) in all_patients:
                    ...
                    for alerte in alertes:
                        ...
                        cle = f"{patient_id}_{date_courante}_{moment}"
                        ...
                        # Publier sur medicinebox/alerte/{patient_id} → seul l'ESP32 de ce patient reçoit
                        if mqtt_client and mqtt_client.is_connected():
                            ...
                            mqtt_client.publish(f"medicinebox/alerte/{patient_id}", message)
                            alertes_envoyees.add(cle)
                            print(f"🔔 Alerte envoyée : buzzer_on pour patient_{patient_id} {moment} à {heure_actuelle}")
                        else:
